...
public class TbDevice implements Serializable {	
	...
	@Id
	@SequenceGenerator(name="TB_DEVICE_DEVICEID_GENERATOR", sequenceName="TB_DEVICE_SEQ",allocationSize=1)
	...
	@ManyToOne
	@JoinColumn(name="VALIDATE_DEVICE_STATE_ID")
	private TbValidateDeviceState validateDeviceStateId;
	...
	public void setValidateDeviceStateId(TbValidateDeviceState validateDeviceStateId) {
		this.validateDeviceStateId = validateDeviceStateId;
	}

	public TbValidateDeviceState getValidateDeviceStateId() {
