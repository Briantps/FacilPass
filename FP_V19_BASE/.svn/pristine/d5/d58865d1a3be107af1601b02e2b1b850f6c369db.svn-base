...
public class SummaryAccountMoveBeanAdmin extends AbstractBaseReportBean implements Serializable{
	...
	public SummaryAccountMoveBeanAdmin(){
...
//		Object[][] dataSource = transactionEJB.getSumaryByAccount(idClient,accountId, dateIni1, dateEnd1);
//		SumaryReportDataSource ds = new SumaryReportDataSource(dataSource);
	...
	protected Map<String, Object> getReportParameters() {
		...
		System.out.println("saldoInicial" +previousBalance);
				...
				if(accountId!=0L){
					if(dateIni!=null && dateEnd!=null){
						...
						if(dateIni.getTime()>=fechaBase.getTime()){
							...
							this.setShowMessageError(true);
							this.setMessageError("El reporte Resumen Movimiento Cuenta FacilPass se generará a partir de "+ fechaI);
							this.setShowData(false);
						}
					}
					else{
