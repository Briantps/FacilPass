...
public interface  ChannelI {
	...
	public boolean inactiveActiveChannel (Long idChannel,Long codeChannel,String ip,Long creationUser) throws SQLException;
	public boolean deleteChannel(Long idChannel,Long codeChannel,String ip,Long creationUser)throws SQLException;
	public Long existChannel(Long idAgreementBank, Long codeChannel, int i);
}
