...
public class TbUmbral implements Serializable {
	...
	@Column(name = "UMBRAL_MODIFICATION_TIME")
	private Timestamp umbralModificationTime;
	...
	public void setUmbralModificationTime(Timestamp umbralModificationTime) {
		this.umbralModificationTime = umbralModificationTime;
	}

	public Timestamp getUmbralModificationTime() {
		return umbralModificationTime;
	}
