...
<body ondragstart="return false" onmouseup="mouseUpBody();">
	...
	<f:view>
						...
						<h:form id="notlogged" rendered="#{!loginMBean.logged}">
							<table height="150px">
								...
								<tr>
									...
									<td>
										<div style="margin-left: 80%">
											<h:outputText styleClass="login-text" value="Contraseña" />
										</div></td>
		...
		<rich:modalPanel id="pOtp" width="630" height="130"
			...
			<h:form id="frmOtp">
				<h:outputText
					value="Señor usuario ingrese el código que le fue enviado a su cuenta de correo electrónico registrada en el sistema."
					styleClass="messageLabel" />
				...
				<h:panelGrid columns="4" styleClass="tableBO">
					...
					<h:panelGroup>
						<h:commandButton value="Aceptar" action="#{loginMBean.rediConfig}"
							style="width: 135px" />
						<rich:spacer width="10" />
						<h:commandButton value="Recordar más tarde"
		...
		<rich:modalPanel id="panelExit" width="360" height="115"
			...
			<h:outputText value="Su Sesión ha Terminado."
				styleClass="messageLabel" />
			<rich:spacer height="10" />
