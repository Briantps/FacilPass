 ...
 * 
 */
public class ReportPuntoRecg extends AbstractBaseReportBean {

	private final String COMPILE_FILE_NAME = "clearingPunto";
	...
	protected String getFileName() {
		return "Reporte_Recargas_Concesion_"+System.currentTimeMillis();
	}
	...
	protected Map<String, Object> getReportParameters() {
		...
		reportParameters.put("TITTLE", "RECAUDO POR PUNTO");
		reportParameters.put("fecIni", begDate);
		reportParameters.put("fecFin", endDate);	
		reportParameters.put("tipo", 1L);
