...
public class ReportIndividualByVehicleBean extends AbstractBaseReportBean implements Serializable{
	...
	public ReportIndividualByVehicleBean(){
					    ...
					    if(dateEnd.getTime()>= dateIni.getTime()){
						    if(dateEnd.getTime()<=(new Date()).getTime()){
							    if(accountId>0){
							    	...
							    	this.setShowMessageError(true);
							    	this.setMessageError("Error: Seleccione una cuenta.");
							    	this.setShowData(false);
							    }
						    }
						    else{
