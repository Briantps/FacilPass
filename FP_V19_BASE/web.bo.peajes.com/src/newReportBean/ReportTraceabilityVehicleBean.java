...
public class ReportTraceabilityVehicleBean extends AbstractBaseReportBean implements Serializable{
	...
	public ReportTraceabilityVehicleBean(){
			...
			System.out.println("Fecha Inicial: " + fechaInicialDef + " fecha converitda: " +fechaIniParametrizada);
 				...
 				if(dateIni!=null && dateEnd!=null){
 				 if(dateIni.getTime() >= fechaIniParametrizada.getTime()){	
					...
					this.setShowMessageError(true);
					this.setMessageError("El reporte Trazabilidad Por Vehículo se generará a partir de " + fechaInicial);
					this.setShowData(false);
			      }
				} 				
				else{
