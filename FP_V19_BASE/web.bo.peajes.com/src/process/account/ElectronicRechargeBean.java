...
//					this.setModalMessage("El Saldo cuenta FacilPass tiene caracteres inválidos. Verifique.");
//					this.showModal = true;
					this.modalMinimumBalanceMessage = "El Saldo cuenta FacilPass tiene caracteres inválidos. Verifique.";
...
//					this.showModal = true;
	...
	/**
	 * Indica si se debe validar el campo de saldo mínimo
	 * @return true si seleccionó saldo mínimo y la cuenta seleccionada es prepago
	 */
	...
	/**
	 * Indica si no se debe validar el campo de saldo mínimo
	 * @return true si seleccionó saldo mínimo y la cuenta seleccionada es prepago
	 */
	...
	/**
	 * Indica si se debe o no validar el campo de saldo mínimo acorde al tipo de cuenta seleccionada
	...
	/**
	 * Oculta la venta de aviso de error de valor de saldo mínimo
	 */
