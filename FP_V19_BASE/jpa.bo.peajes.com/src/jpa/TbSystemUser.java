...
/**
 * The persistent class for the TB_SYSTEM_USER database table.
 * 
 */
@Entity
...
public class TbSystemUser implements Serializable {
	...
	@SequenceGenerator(name = "TB_SYSTEM_USER_TBSYSTEMUSERID_GENERATOR", sequenceName = "TB_SYSTEM_USER_SEQ",allocationSize=1)
	@Column(name="USER_ID")
	private Long userId;
    ...
    @Column (name = "USER_COUNT_QUESTIONS")
	private Integer userCountQuestions;
    ...
    @Column (name = "USER_QUESTIONS_DATE")
    private Timestamp userQuestionsDate;
    
    @Column(name = "USER_OTP_STATE")
	private Integer userOtpState;
    
    @ManyToOne
	@JoinColumn(name = "USER_STATE_OLD")
	private TbUserStateType userStateOld;
	...
	public void setUserQuestionsDate(Timestamp userQuestionsDate) {
		this.userQuestionsDate = userQuestionsDate;
	}

	public Timestamp getUserQuestionsDate() {
		return userQuestionsDate;
	}

	public void setUserOtpState(Integer userOtpState) {
		this.userOtpState = userOtpState;
	}

	public Integer getUserOtpState() {
		return userOtpState;
	}

	public void setUserStateOld(TbUserStateType userStateOld) {
		this.userStateOld = userStateOld;
	}

	public TbUserStateType getUserStateOld() {
		return userStateOld;
	}

	public void setUserCountQuestions(Integer userCountQuestions) {
		this.userCountQuestions = userCountQuestions;
	}

	public Integer getUserCountQuestions() {
		return userCountQuestions;
	}
