...
public class TbAutomaticRecharge implements Serializable {
	...
	/*
	 * @Column(name="AUTOMATIC_RECHARGE_FRECUENCY") private Long
	 * automaticRechargeFrecuency;
	 */
	...
	/*
	 * @Column(name = "DATE_CHANGE_STATE") private Timestamp dateChangeState;
	 */
	...
	@ManyToOne
	@JoinColumn(name = "TYPE_PROGRAMMING_ID")
	private TbTypeProgramming typeProgramming;
	...
	public TbTypeProgramming getTypeProgramming() {
		return typeProgramming;
	}

	public void setTypeProgramming(TbTypeProgramming typeProgramming) {
